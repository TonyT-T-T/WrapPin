...
Pairing records grant privileged local access to the paired device and must be treated as secrets. WrapPin stores its record in the iPhone Keychain and does not upload it. If a record is ever exposed, remove the pairing in WrapPin and pair the iPhone again.
