...
修订后的本地测试包为 `WrapPin-1.0.9-build21-location-probe.ipa`，SHA-256 为 `a0169e3c95d0e5eef3de2ca049cde73cec1715e67bc66a10336c98c97ad9c859`。它从无签名 Release 归档打包，Build 核对为 21，ZIP 完整性检查通过；尚未真机安装验收，也不是定位偏差修复版。Build 20 仅保留为诊断工具初版记录，不应继续用来等待回调。
